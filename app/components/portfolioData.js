export const portfolioData = [
  {
    ...
    caseStudy: {
      ...
      images: [
        { img: "https://dummyimage.com/600x900/dcdcaa&text=0-1", alt: "alt" },
        { img: "https://dummyimage.com/1203x503&text=0-2", alt: "alt" },
        { img: "https://dummyimage.com/1203x503&text=0-3", alt: "alt" },
      ],
    },
    bgFromColor: "from-red-500",
    shortDecs: "shortDecs",
    images: [
      { img: "https://dummyimage.com/600x900&text=0-1", alt: "alt" },
      { img: "https://dummyimage.com/1203x503&text=0-2", alt: "alt" },
      { img: "https://dummyimage.com/1203x503&text=0-3", alt: "alt" },
    ],
  },
  {
    ...
    shortDecs: "shortDecs",
    images: [
      { img: "https://dummyimage.com/1203x503&text=1-0", alt: "alt" },
